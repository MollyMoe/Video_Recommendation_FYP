...
// We no longer need the Lock icon here, but it's fine to leave it.
import { Play, Heart, Bookmark, Trash2, Lock } from "lucide-react"; 
// We no longer need useState for the message.
        ...
        <Dialog.Panel className="relative bg-white p-6 rounded-2xl max-w-xl w-full space-y-4 shadow-2xl">
          ...
          <div className="flex space-x-6">
            ...
            <div className="flex flex-col justify-center space-y-3 flex-grow">
              ...
              <p className="text-sm text-gray-700"><strong>Genres:</strong> {Array.isArray(movie.genres) ? movie.genres.join(", ") : movie.genres || "N/A"}</p>
