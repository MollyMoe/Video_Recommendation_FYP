...
function MovieModal({
  ...
  const playDisabled = !isSubscribed || !isOnline;
        ...
        <Dialog.Panel className="relative bg-white p-6 rounded-2xl max-w-xl w-full space-y-4 shadow-2xl">
          ...
          <div className="flex justify-between space-x-2 pt-4 border-t border-gray-200">
            ...
            <button
              ...
              className={`flex items-center justify-center w-20 text-xs px-2 py-1 rounded-lg shadow-sm ${
                playDisabled
            ...
            >
              <Play
                className={`w-3 h-3 mr-1 ${
                  playDisabled ? "text-gray-400" : "text-black"
                } fill-current`}
              />
              Play
            </button>
