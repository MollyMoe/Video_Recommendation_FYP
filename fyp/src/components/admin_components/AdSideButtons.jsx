    ...
    >
        <div className="fixed left-5 h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
            <button className="bg-white border border-gray-400 text-black text-md px-4 py-1 mt-10 rounded-lg shadow-md hover:bg-gray-200">
                <SideButton to="/admin" label="Home" current={location.pathname === '/admin'} />    
            </button>
            <br></br>
            <button
            className="bg-white border border-gray-400 text-black text-md px-4 py-2 mt-10 rounded-lg shadow-md hover:bg-gray-200">
                Update
            </button>
        </div>
    </aside>
