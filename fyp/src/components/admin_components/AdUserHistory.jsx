              ...
              >
                ...
                <div className="flex flex-col flex-1 px-4 pt-3 pb-2">
                  ...
                  <div className="m-0 flex justify-center gap-3">
                    {/* Admin "Play" button should be disabled or lead to a preview, not track history */}
                    <button
                      onClick={() => console.log("Admin Play clicked (implement preview logic if needed)")}
                      className="flex items-center justify-center w-20 bg-gray-300 text-gray-800 text-xs px-2 py-1 rounded-lg shadow-sm cursor-not-allowed"
                      disabled // Disable as admin doesn't track history for themselves
                    >
