...
//     console.log("🔍 searchQuery changed:", trimmed);
//     if (!trimmed) {
...
// // // ✅ Enhanced search effect with full console logs
// // useEffect(() => {
// //   const trimmed = searchQuery?.trim();
// //   console.log("🔍 searchQuery changed:", trimmed);

// //   // If search is empty, show recommended movies
// //   if (!trimmed || trimmed.length < 2) {
// //     console.log("🧹 Empty or short query. Showing last recommended.");
// //     setMovies(lastRecommendedMovies.slice(0, 99));
// //     return;
// //   }

// //   const debouncedFetch = debounce(async () => {
// //     console.log("📨 Sending search request for:", trimmed);
// //     try {
// //       const res = await axios.get(`${API}/api/movies/search`, {
// //         params: { q: trimmed },
// //       });
...
// //       console.log("🎯 Final filtered search results:", deduped);
// //       setMovies(deduped.slice(0, 99));
// //     } catch (err) {
// //       console.error("❌ Search failed:", err);
// //       setMovies([]);
...
//       setPopupMessage("Movie is deleted.");
//       setShowPopup(true);
