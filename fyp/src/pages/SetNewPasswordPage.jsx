...
const SetNewPasswordPage = () => {
  ...
  // --- CORRECTED: Decode the URL-encoded token before using it ---
  ...
  const handleSubmit = async (e) => {
    ...
    // --- ADDED: Logging to debug what is being sent ---
    console.log("Client sending token:", token);
    console.log("Client sending password:", formData.password);
    // --- END OF ADDITION ---
    ...
    try {
      ...
      // --- ADDED: Log the server's full response ---
      ...
      if (res.ok) {
        ...
        setMessage({ type: "error", text: data.detail || "Invalid token or server error" });
      }
    } catch (err) {
